function tau_env = disturbance_7dof_observer(t, nu_k, J_inv_k_full, Z_depth, DL_env)
    %% 环境扰动参数
    % 洋流速度，惯性坐标系下
    ...
    tau_env(1:6) = tau_env(1:6) + tau_wave_body;

    %% 3. 随机噪声

    tau_noise = K_NOISE * randn(6, 1);
    tau_env(1:6) = tau_env(1:6) + tau_noise;
    tau_env(7) = 0;
end